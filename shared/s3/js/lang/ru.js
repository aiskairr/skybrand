...
window._s3Lang['DELIGATE_DELIVERY_RUS_POST_NOTE'] = "Доставка по всей Кыргызстана!";
...
window._s3Lang['DIGITAL_AMOUNT_CHANGE_ERROR'] = "Невозможно отредактировать заказ. В заказе присутствует цифровой товасом <br>Любое изменение содержимого заказа (смена цены, количества, добавление новых позиций и псом) может повлечь за собой некорректное поведение системы";
...
window._s3Lang['JS_SHOP2_PRODUCT_COPY_MESSAGE'] = "Создана копия товара \"%PRODUCT%\". Копия скрыта на сайте и закрыта от индексации поисковыми системами, поскольку содержит дублирующие SEO-параметры и название. Адрес копии также дублируется, но к нему дописывается порядковый номесом";
...
window._s3Lang['JS_UPLOADING'] = "Загрузка на сервесом..";
